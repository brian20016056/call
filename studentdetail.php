...
if (isset($_GET['studentId'])) {
  $colname_Recordset1 = $_GET['studentId'];
}
mysql_select_db($database_memberConn, $memberConn);
$query_Recordset1 = sprintf("SELECT * FROM studentdata WHERE studentId = %s", GetSQLValueString($colname_Recordset1, "text"));
...
if (isset($_GET['studentId'])) {
  $colname_Recordset2 = $_GET['studentId'];
}
mysql_select_db($database_memberConn, $memberConn);
$query_Recordset2 = sprintf("SELECT * FROM rollcalldata INNER JOIN classdata ON rollcalldata.classId = classdata.classId WHERE studentId = %s AND rollcalldata.rollcallCount=1", GetSQLValueString($colname_Recordset2, "text"));
...
if ((isset($_GET['callrollId'])) && ($_GET['callrollId'] != "") && (isset($_GET['del2']))) {
	for($x=0; $x<$_GET['classCount']; $x++){
  $deleteSQL = sprintf("DELETE FROM rollcalldata WHERE callrollId=%s",
                       GetSQLValueString($_GET['callrollId']+$x, "int"));
 ...
 <p>
  ...
  <div class="content" id="content">
    ...
    <div align="center" class="課程資訊";>學生資料<br>
              <table width="95%" border="1" cellpadding="1" cellspacing="0" bordercolor="#A4BAE0">
                <tr>
                  ...
                  <td width="180" align="center" valign="middle">建檔日期</td>
                  <td width="180" align="center" valign="middle">入班日期</td>
                ...
                <tr>
                  ...
                  <td align="center"><?php echo $row_Recordset1['studentBuilddate']; ?></td>
                  <td align="center"><?php echo $row_Recordset1['studentJoindate']; ?></td>
                  <td align="center"><?php echo $row_Recordset1['studentNote']; ?></td>
                  <td align="center"><a href="renewstudent.php?studentId=<?php echo $row_Recordset1['studentId']; ?>">更新資料</a> <a href="search_student.php?del1=true&amp;studentId=<?php echo $row_Recordset1['studentId']; ?>">刪除學生</a></td>
                </tr>
              </table>
...
<br>
<div class="課程資訊">
  <div align="center">學生課程資料
    <div>
      
        <table width="500px" border="1" cellpadding="1" cellspacing="0" bordercolor="#A4BAE0">
          <tr>
            <td width="80" align="center" valign="middle">課程名稱</td>
            <td width="30" align="center" valign="middle">上課日</td>
            <td width="30" align="center" valign="middle">上課時間</td>
            <td width="30" align="center" valign="middle"></td>
          </tr>
            <?php do { ?>
          <tr>
            <td width="50" height="30" align="center" valign="middle"><?php echo $row_Recordset2['calssName']; ?></td>      
			 <td align="center">
                  ...
                  星期四<br>
                  <?php } ?>
                  <?php if($row_Recordset2T['classFRI']==1){ ?>
                  星期五<br>
                  <?php } ?>
            ...
            <td width="50" height="30" align="center" valign="middle"><?php echo substr($row_Recordset2['classStart'], 0, -3); ?></td>
              <td width="30" align="center" valign="middle"><a href="studentdetail.php?del2=true&amp;callrollId=<?php echo $row_Recordset2['callrollId']; ?>&amp;classCount=<?php echo $row_Recordset2['classCount']; ?>">刪除</a>
              <br>
            </tr>
