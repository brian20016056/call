...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE studentdata SET studentName=%s, studentEmail=%s, studentTel=%s, studentParents=%s, studentNote=%s, studentMON=%s, studentTUE=%s, studentWED=%s, studentTHU=%s, studentFRI=%s, studentSAT=%s WHERE studentId=%s",
                       GetSQLValueString($_POST['studentName'], "text"),
                       GetSQLValueString($_POST['studentEmail'], "text"),
                       GetSQLValueString($_POST['studentTel'], "int"),
  ...
  $updateGoTo = "renewstudent.php?Succ=yes";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_memberConn, $memberConn);
$query_Recordset1 = sprintf("SELECT * FROM studentdata WHERE studentId = %s", GetSQLValueString($colname_Recordset1, "int"));
 ...
 <p>
  ...
  <?php 
          ...
          <table width="300" border="1" align="center" cellpadding="1" cellspacing="1">
              <tr>
                <td align="center"><span class="style2">已成功更新學生資料!</span></td>
              </tr>
  </table>
   <?php }?>
<form action="<?php echo $editFormAction; ?>" name="form1" method="POST" id="form1">

<input name="studentId" type="hidden" value="<?php echo $_GET['studentId']; ?>">
  *學生姓名:
  <input name="studentName" type="text" value="<?php echo $row_Recordset1['studentName']; ?>">
  <br>
  *學生Email:
  <input name="studentEmail" type="text" value="<?php echo $row_Recordset1['studentEmail']; ?>">
  <br>
  *連絡電話:
  <input name="studentTel" type="text" value="<?php echo $row_Recordset1['studentTel']; ?>">
  <br>
   *聯絡人:
  <input name="studentParents" type="text" value="<?php echo $row_Recordset1['studentParents']; ?>">
  <br>
  訂餐日期:
  <br>
  <input name="day1" type="checkbox" class="checkbox"><label>星期一</label>
<input name="day2" type="checkbox" class="checkbox"><label>星期二</label>
<input name="day3" type="checkbox" class="checkbox"><label>星期三</label>
<br>
<input name="day4" type="checkbox" class="checkbox"><label>星期四</label>
<input name="day5" type="checkbox" class="checkbox"><label>星期五</label>
<input name="day6" type="checkbox" class="checkbox"><label>星期六</label>
  <br>
  *備註:
  <br>
  <textarea name="studentNote" cols="35" rows="10" value="<?php echo $row_Recordset1['studentNote']; ?>"></textarea>
  <br>
