...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE classdata SET calssName=%s, classStart=%s, classTime=%s, classNote=%s, classCount=%s, classMON=%s, classTUE=%s, classWED=%s, classTHU=%s, classFRI=%s, classSAT=%s WHERE classId=%s",
                       ...
                       GetSQLValueString(isset($_POST['classMON']) ? "true" : "", "defined","1","0"),
                       GetSQLValueString(isset($_POST['classTUE']) ? "true" : "", "defined","1","0"),
                       GetSQLValueString(isset($_POST['classWED']) ? "true" : "", "defined","1","0"),
                       GetSQLValueString(isset($_POST['classTHU']) ? "true" : "", "defined","1","0"),
                       GetSQLValueString(isset($_POST['classFRI']) ? "true" : "", "defined","1","0"),
                       GetSQLValueString(isset($_POST['classSAT']) ? "true" : "", "defined","1","0"),
...
mysql_select_db($database_memberConn, $memberConn);
$query_Recordset2 = sprintf("SELECT * FROM classdata INNER JOIN teacherdata ON classdata.teacherId = teacherdata.teacherId WHERE classId = %s", GetSQLValueString($colname_Recordset2, "int"));
 ...
 *課程名稱:
   <?php echo $row_Recordset2['calssName']; ?>
   <br>
   *教師名稱:
   <?php echo $row_Recordset2['teacherName']; ?>
  <br>
  *上課日:
  <br>
  <input name="classMON" type="checkbox" class="checkbox" value="1" checked><label>星期一</label>
<input name="classTUE" type="checkbox" class="checkbox" value="1" checked><label>星期二</label>
<input name="classWED" type="checkbox" class="checkbox" value="1" checked><label>星期三</label>
<br>
<input name="classTHU" type="checkbox" class="checkbox" value="1" checked><label>星期四</label>
<input name="classFRI" type="checkbox" class="checkbox" value="1" checked><label>星期五</label>
<input name="classSAT" type="checkbox" class="checkbox" value="1" checked><label>星期六</label>
<br>
*起始時間:
  <input name="classStart" type="time" value="<?php echo $row_Recordset2['classStart']; ?>"/>
  <br>
  *課堂時間(時):
  ...
  *備註:
  <br>
  <textarea name="classNote" cols="35" rows="10" value="<?php echo $row_Recordset2['classNote']; ?>"></textarea>
  <br>
  <input type="hidden" name="MM_update" value="form1">
  <input type="submit" name="home" id="按鈕" value="確認">
</form>
</div>
</div>
</body>
