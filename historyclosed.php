...
mysql_select_db($database_memberConn, $memberConn);
$query_Recordset1 = sprintf("SELECT * FROM closeddata INNER JOIN classdata ON closeddata.classId=classdata.classId WHERE MONTH(closedDate)=%s AND YEAR(closedDate)=%s", GetSQLValueString($colname2_Recordset1, "int"),GetSQLValueString($colname3_Recordset1, "int"));
...
<br>
  <form action="historyclosed.php" method="get" name="search2">
