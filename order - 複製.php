...
if (isset($_GET['1'])) {
  $colname_Recordset4 = $_GET['1'];
}
mysql_select_db($database_memberConn, $memberConn);
$query_Recordset4 = sprintf("SELECT * FROM studentdata WHERE studentTHU = %s", GetSQLValueString($colname_Recordset4, "int"));
...
if (isset($_GET['1'])) {
  $colname_Recordset5 = $_GET['1'];
}
mysql_select_db($database_memberConn, $memberConn);
$query_Recordset5 = sprintf("SELECT * FROM studentdata WHERE studentFRI = %s", GetSQLValueString($colname_Recordset5, "int"));
...
<br>
<div> 
        <table width="80%" border="1" cellpadding="1" cellspacing="0" bordercolor="#A4BAE0">
            <tr>
            ...
            <tr>
              ...
              <td width="50" height="30" align="center" valign="middle"><?php echo ($totalRows_Recordset2)-($totalRows_Recordset8) ?>人</td></td>
              <td width="50" height="30" align="center" valign="middle"><?php echo ($totalRows_Recordset3)-($totalRows_Recordset9) ?>人</td></td>
              <td width="50" height="30" align="center" valign="middle"><?php echo ($totalRows_Recordset4)-($totalRows_Recordset10) ?>人</td></td>
              <td width="50" height="30" align="center" valign="middle"><?php echo ($totalRows_Recordset5)-($totalRows_Recordset11) ?>人</td></td>
              <td width="50" height="30" align="center" valign="middle"><?php echo ($totalRows_Recordset6)-($totalRows_Recordset12) ?>人</td></td>
              </tr>
            <tr>
              <?php do { ?>
              ...
              <?php do { ?>
                <form action="<?php echo $editFormAction; ?>" method="POST" name="sander2">
              ...
              <?php do { ?>
                <form action="<?php echo $editFormAction; ?>" method="POST" name="sander3">
                  ...
                  <td width="50" height="30" align="center" valign="middle"><?php echo $row_Recordset3['studentName']; ?><input  type="submit" value="退訂" name="set">
                    <input type="hidden" name="MM_insert" value="sander3">
                  </form>
                </td>
                <?php } while ($row_Recordset3 = mysql_fetch_assoc($Recordset3)); ?>
              <?php do { ?>
                <form action="<?php echo $editFormAction; ?>" method="POST" name="sander4">
                  ...
                  <td width="50" height="30" align="center" valign="middle"><?php echo $row_Recordset4['studentName']; ?><input  type="submit" value="退訂" name="set">
                    <input type="hidden" name="MM_insert" value="sander4">
                </form>
                </td>
                <?php } while ($row_Recordset4 = mysql_fetch_assoc($Recordset4)); ?>
                <?php do { ?>
              <form action="<?php echo $editFormAction; ?>" method="POST" name="sander5">
                ...
                <td width="50" height="30" align="center" valign="middle"><?php echo $row_Recordset5['studentName']; ?><input  type="submit" value="退訂" name="set">
                  <input type="hidden" name="MM_insert" value="sander5">
              </form>
              </td>
              <?php } while ($row_Recordset5 = mysql_fetch_assoc($Recordset5)); ?>
              <?php do { ?>
              <form action="<?php echo $editFormAction; ?>" method="POST" name="sander6">
                ...
                <td width="50" height="30" align="center" valign="middle"><?php echo $row_Recordset6['studentName']; ?><input  type="submit" value="退訂" name="set">
                  <input type="hidden" name="MM_insert" value="sander6">
              </form>
              </td>
