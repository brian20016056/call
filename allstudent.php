...
mysql_select_db($database_memberConn, $memberConn);
$query_Recordset1 = sprintf("SELECT DISTINCT(historyclassDate),studentName,classdata.calssName,classdata.classStart FROM historyclassdata INNER JOIN (rollcalldata INNER JOIN classdata ON rollcalldata.classId=classdata.classId) ON historyclassdata.classId=classdata.classId WHERE MONTH(historyclassdata.historyclassDate)=%s AND YEAR(historyclassdata.historyclassDate)=%s AND rollcalldata.rollcallCount<=(SELECT MAX(historyCount) FROM historyclassdata)", GetSQLValueString($colname2_Recordset1, "int"),GetSQLValueString($colname3_Recordset1, "int"));
...
<br>
  <form action="allstudent.php" method="get" name="search2">
...
<input type="submit" name="search2" value="搜尋">
    ...
    <div align="center" class="課程資訊";>學生出缺席查詢<br>
              <table width="80%" border="1" cellpadding="1" cellspacing="0" bordercolor="#A4BAE0">
                <tr>
                  <td width="100" align="center" valign="middle">學生名稱</td>
                  <td width="100" align="center" valign="middle">課程名稱</td>
                  <td width="100" align="center" valign="middle">課程起始</td>
                  <td width="100" align="center" valign="middle">上課日期</td>
                  <td width="50" align="center" valign="middle">出缺席</td>
                </tr>
                <?php do { ?>
                <tr>
                  ...
                  <td width="100" align="center" valign="middle"><?php echo $row_Recordset1['historyclassDate']; ?></td>
                  <?php if($row_Recordset1['rollcall']==0){ ?>
