...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "sander2")) {
  $updateSQL = sprintf("UPDATE rollcalldata SET rollcall=%s WHERE callrollId=%s",
                       GetSQLValueString($_POST['setzero'], "int"),
...
if (isset($_GET['new'])) {
  ...
  $colname2_Recordset2 = ($totalRows_Recordset5)+1 ;

mysql_select_db($database_memberConn, $memberConn);
$query_Recordset2 = sprintf("SELECT * FROM rollcalldata INNER JOIN studentdata ON rollcalldata.studentId = studentdata.studentId WHERE classId = %s AND rollcallCount=%s ORDER BY classId ASC", GetSQLValueString($colname_Recordset2, "text"),GetSQLValueString($colname2_Recordset2, "int"));
...
if (isset($_GET['new'])) {
  $colname_Recordset6 = $_GET['new'];
}
mysql_select_db($database_memberConn, $memberConn);
$query_Recordset6 = sprintf("SELECT * FROM historyclassdata WHERE classId = %s AND historyclassDate=CURDATE()", GetSQLValueString($colname_Recordset6, "int"));
...
if (isset($_GET['new'])) {
  $colname_Recordset7 = $_GET['new'];
}
mysql_select_db($database_memberConn, $memberConn);
$query_Recordset7 = sprintf("SELECT * FROM closeddata WHERE classId = %s AND closedDate=CURDATE()", GetSQLValueString($colname_Recordset7, "int"));
...
<div id="wrapper">
 ...
 <p>
  ...
  <div class="content" id="content">
    <?php if ($totalRows_Recordset6 == 0 && $totalRows_Recordset7 == 0) { // Show if recordset empty ?>
    <div align="center" class="課程資訊";>課程資料<br>
        <table width="70%" border="1" cellpadding="1" cellspacing="0" bordercolor="#A4BAE0">
          ...
          <tr>
            ...
            <?php }　?>
            <td align="center"><a href="classdetail.php?del1=true&amp;classId=<?php echo $row_Recordset1['classId']; ?>">刪除課程</a></td>
          </tr>
  ...
  <div class="課程資訊"><div align="center">學生資料<div>
    <table width="500px" border="1" cellpadding="1" cellspacing="0" bordercolor="#A4BAE0">
      <tr>
        <td width="50" align="center" valign="middle">學生姓名</td>
        <td width="50" align="center" valign="middle">出席狀況</td>
      ...
      <?php do { ?>
        <tr>
          ...
          <?php if ($row_Recordset2['rollcall'] == 1){ ?>
          <form action="<?php echo $editFormAction; ?>" method="POST" name="sander1" id="rollcall">
          <input type="hidden" value="<?php echo $row_Recordset2['callrollId']; ?>" name="IDnumber" id="IDnumber">
          <input type="hidden" value="0" name="setzero" id="setzero">
          <td width="50" align="center" valign="middle"><div id="red">缺席</div></td>
          <td width="30" align="center" valign="middle">
            <input  type="submit" value="標記出席" name="set">
          </td>
          <?php } 
             else { ?>
          <form action="<?php echo $editFormAction; ?>" method="POST" name="sander2" id="rollcall">
            <input type="hidden" value="<?php echo $row_Recordset2['callrollId']; ?>" name="IDnumber" id="IDnumber">
            <input type="hidden" value="1" name="setzero" id="setzero">
            <td width="50" align="center" valign="middle">出席</td>
            <td width="30" align="center" valign="middle">
  ...
  <?php if ($totalRows_Recordset6 > 0) { // Show if recordset not empty ?>
    <table width="300" border="1" align="center" cellpadding="1" cellspacing="1">
      <tr>
        <td align="center" bgcolor="#FFF" ><span class="style2">今日已點名完成！</span></td>
      </tr>
    </table>
    <br>
  ...
  <?php if ($totalRows_Recordset7 > 0) { // Show if recordset not empty ?>
    <table width="300" border="1" align="center" cellpadding="1" cellspacing="1">
      <tr>
        <td align="center" bgcolor="#FFF" ><span class="style2">今日已停課！</span></td>
      </tr>
    </table>
    <br>
    <div align="center"> <a href="home.php">
