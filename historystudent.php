...
<div id="wrapper">
 ...
 <p>
  ...
  <form action="historystudent.php" method="get" name="search2">
    ...
    <div align="center" class="課程資訊";>學生資料<br>
              <table width="95%" border="1" cellpadding="1" cellspacing="0" bordercolor="#A4BAE0">
                ...
                <tr>
                  ...
                  <td align="center"><a href="historyabsence.php?studentId=<?php echo $row_Recordset1['studentId']; ?>&searchdate=<?php echo date('Y/m/j') ?>">缺席資料</a>
                  </td>
                </tr>
