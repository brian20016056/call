...
<div id="wrapper">
 ...
 <p>
  ...
  <form action="search_student.php" method="get" name="search2">
    ...
    <div align="center" class="課程資訊";>學生資料<br>
              <table width="95%" border="1" cellpadding="1" cellspacing="0" bordercolor="#A4BAE0">
                ...
                <tr>
                  ...
                  <td align="center"><a href="studentdetail.php?studentId=<?php echo $row_Recordset1['studentId']; ?>">詳細資料</a>
                  <a href="search_student.php?del1=true&amp;studentId=<?php echo $row_Recordset1['studentId']; ?>">刪除學生</a>
                  </td>
                </tr>
